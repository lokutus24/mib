...
class MibManagerCallbacks extends MibBaseController
{
	...
	public function optionFilters()
	{
		...
		<div class='row' style='margin-bottom: 10px;'>
			Lakópark ID-k: <input type='text' name='residential_park_ids' size='45' value='<?= $residential_park_ids; ?>'
				placeholder='pl. 7,9,10'>
		</div>
		<div class="row" style="margin-bottom: 10px;">
		...
		<div class="row" style="margin-bottom: 10px;">
			...
			<input type="text" name="mib-filter-floor-from" size="20" value="<?= $floor_from; ?>"
				placeholder="tól. földszint = 0">
		...
		<div class="row" style="margin-bottom: 10px;">
			Slider helyett szám inputok: <input type="checkbox" name="mib-filterslider_checked" size="45"
				<?= $filterslider_checked; ?>>
		</div>
		...
		<div class="row" style="margin-bottom: 10px;">
			Támogatással elérhető ár megjelenítése: <input type="checkbox" name="mib-display_supported_price" size="45"
				<?= $mib_display_supported_price; ?>>
		</div>
		...
		<table class="options-table-responsive dt-options-table">
			<tbody>
				<tr id="dt_desc_box">
					...
					<td class="field">
						<input type="text" name="mib-login-email" size="45"
							value="<?= isset($mib_options['mib-login-email']) ? esc_html($mib_options['mib-login-email']) : ''; ?>">
					</td>
				</tr>
				<tr id="dt_desc_box">
					<td class="label">
					...
					<td class="field">
						<input type="text" name="mib-login-password" size="45"
							value="<?= isset($mib_options['mib-login-password']) ? esc_html($mib_options['mib-login-password']) : ''; ?>">
					</td>
				</tr>
				<tr id="dt_desc_box">
					<td class="label">
					...
					<td class="field">
						<input type="text" name="mib-residential-park-id" size="45"
							value="<?= isset($mib_options['mib-residential-park-id']) ? esc_html($mib_options['mib-residential-park-id']) : ''; ?>">
						<!-- Új mező input -->
					</td>
				</tr>
		...
		<form method="post" id="shortcode-form">
			...
			<p>
				...
				$extra_options = [
					...
					'discount_price_filter' => 'Akciós árak szűrő',
	...
	public function colorOptions()
	{
		...
		<tr id="dt_desc_box">
			...
			<td class="field">
				<input type="color" name="mib-first-color" size="45"
					value="<?= isset($mib_color_options['mib-first-color']) ? esc_html($mib_color_options['mib-first-color']) : ''; ?>">
			</td>
		</tr>
		...
		<tr id="dt_desc_box">
			...
			<td class="field">
				<input type="color" name="mib-second-color" size="45"
					value="<?= isset($mib_color_options['mib-second-color']) ? esc_html($mib_color_options['mib-second-color']) : ''; ?>">
			</td>
		</tr>
		...
		<tr id="dt_desc_box">
			...
			<td class="field">
				<input type="color" name="mib-third-color" size="45"
					value="<?= isset($mib_color_options['mib-third-color']) ? esc_html($mib_color_options['mib-third-color']) : ''; ?>">
			</td>
		</tr>
		...
		<tr id="dt_desc_box">
			...
			<td class="field">
				<input type="color" name="mib-apartment-slider-active-color" size="45"
					value="<?= isset($mib_color_options['mib-apartment-slider-active-color']) ? esc_html($mib_color_options['mib-apartment-slider-active-color']) : ''; ?>">
			</td>
		</tr>
		...
		<tr id="dt_desc_box">
			...
			<td class="field">
				<input type="color" name="mib-apartment-slider-inactive-color" size="45"
					value="<?= isset($mib_color_options['mib-apartment-slider-inactive-color']) ? esc_html($mib_color_options['mib-apartment-slider-inactive-color']) : ''; ?>">
			</td>
		</tr>
		...
		<tr id="dt_desc_box">
			...
			<td class="field">
				<input type="color" name="mib-apartment-color" size="45"
					value="<?= isset($mib_color_options['mib-apartment-color']) ? esc_html($mib_color_options['mib-apartment-color']) : ''; ?>">
			</td>
		</tr>
		...
		<tr id="dt_desc_box">
			...
			<td class="field">
				<input type="color" name="mib-apartment-table-color" size="45"
					value="<?= isset($mib_color_options['mib-apartment-table-color']) ? esc_html($mib_color_options['mib-apartment-table-color']) : ''; ?>">
			</td>
		</tr>
